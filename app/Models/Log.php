...
class Log extends Model
{
    ...
    protected $fillable = [
        ...
        'content',
        'user_id',
        'log_category_id',  // Changed from 'category_id'
        'is_pinned',
    ];
    ...
    {
        return $this->belongsTo(LogCategory::class, 'log_category_id');  // Updated
    }
    ...
    {
        return $this->hasMany(LogAttachment::class)->where('type', 'image');
    }

    public function documents(): HasMany
    {
        return $this->hasMany(LogAttachment::class)->where('type', 'document');
    }
    ...
    {
        return $this->hasMany(LogShare::class);
    }

    public function activeShares(): HasMany
    {
        return $this->hasMany(LogShare::class)->active();
    }

    // Check if log is shared with a specific user
    ...
    // Check if user can edit this log (owner or has edit permission)
    ...
    // Scope for user's own logs
    public function scopeOwnedBy($query, $userId)
    {
        return $query->where('user_id', $userId);
    }

    // Scope for logs shared with user
    ...
    // Scope for all logs accessible by user (owned + shared)
