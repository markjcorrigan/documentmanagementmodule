...
class Document extends Model
{
    ...
    public function getIconAttribute(): string
    {
        $iconMap = [
            ...
            'json' => 'fa-file-code text-gray-600',
            ...
            'webp' => 'fa-file-image text-purple-600',
            'mp3' => 'fa-file-audio text-indigo-600',
            'wav' => 'fa-file-audio text-indigo-600',
            'ogg' => 'fa-file-audio text-indigo-600',
            'mp4' => 'fa-file-video text-pink-600',
            'webm' => 'fa-file-video text-pink-600',
            'avi' => 'fa-file-video text-pink-600',
        ];
