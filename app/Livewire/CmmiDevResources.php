...
#[Layout('components.layouts.app.frontend', ['title' => 'Cmmi Dev Resources'])]
class CmmiDevResources extends FrontendComponent
{
    public $htmlFiles = [];
    ...
    {
        // Use route-based file serving (works better on Windows)
        return route('cmmi.files', ['path' => $path]);
    }

    public function render()
    {
        return view('livewire.cmmi-dev-resources');
    }
}
