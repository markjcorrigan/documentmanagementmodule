...
class Dashboard extends Component
{
    ...
    public function mount()
    {
        ...
        if ($projectId) {
            $this->currentProject = Project::withCount('pmbokNotes')->find($projectId);
        }
    }
    ...
    {
        return $this->redirect(route('pmbok.spa.projects'));
    }

    protected function getPmbokProcesses()
    {
        return [
    ...
    {
        return view('livewire.pmbok-spa.dashboard');
    }
}
