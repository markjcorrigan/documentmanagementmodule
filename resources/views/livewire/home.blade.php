                                ...
                                <section class="mb-8">
                                    ...
                                    <div x-data="{ videoOpen: false }" class="border border-gray-300 dark:border-blue-900 rounded-lg shadow-sm overflow-hidden mb-4">
                                        ...
                                        >
                                            ...
                                            <div class="px-6 pb-4">
                                                <small class="text-gray-600 dark:text-gray-400" style="font-size: 10px !important;">Credit:  YouTube - Thought Architect. <br>Note: Content incorporates ideas and media from various sources. <br>Going forward and logged in know that all creators are gratefully acknowledged.</small>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        >
                                            ...
                                            <div class="px-6 pb-8">
                                                ...
                                                <div class="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                                                    ...
                                                    <p>We need to move our thinking patterns to incorporate three valued logic per the image below.</p>
                                                    <div class="my-6 flex justify-center">
                                                        <img id="rightwrong"
