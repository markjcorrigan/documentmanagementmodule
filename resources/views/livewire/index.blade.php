<indexpage>
    ...
    <div class="container" align="center">
        ...
        <!--<link rel="stylesheet" href="/fontawesome6/fontawesome6-pro-5.13.0-web/css/all.css" >-->
        ...
        <div class="rTableCell"><a href="/cmmi" title="On a Desktop drag the pin down to your Capability Maturity level now! Or drag the pin through the gateway and hit the Productivity and Quality improvement target!"><img id="pin" class="img-fluid" src="{{ asset('storage/images/pin40.png') }}" alt="pin" /></a><img alt="" class="img-fluid" src="{{ asset('storage/images/gatewayflat.png') }}" onmouseover="this.src='{{ asset('storage/images/gateway.png') }}'" onmouseout="this.src='{{ asset('storage/images/gatewayflat.png') }}'"><a href="/home/carousel?slide=5"><img id="target" class="img-fluid" title="Click the target for the project management and other processes to maintain and improve up to Capability Maturity Level 5" src="{{ asset('storage/images/targetsmall.png') }}" alt="target" /></a></div>
        <div class="rTableCell"></div>
        </div>
        </div>
        </div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button class="btn align-center clearfix" type="button" data-toggle="collapse" data-target="#collapseperformancestats" aria-expanded="false" aria-controls="collapseperformancestats"><img alt="Animated GIF of Cogs going around and around to illustrate the idea of processes working together" height="50" src="{{ asset('storage/images/cogsworking.gif') }}" width="73" title="Click on the cogs to understand about upping your production stats">
            </button>

            <div class="collapse" id="collapseperformancestats">
                <div class="container">
                    <div class="card text-center">
                        <h5 class="card-header" align="center">PMWay: The Way to Project and Process Management Excellence</h5>
                        <div class="card-body text-center">

                            <h3><b>Tired of the <a href="{{ asset('storage/assets/chaos-report.pdf') }}" >Chaos</a>?</b></h3>

                            <a href="/cmmi" title="Click the image to go to the Capability Maturity Model"><img class="img-fluid" src="{{ asset('storage/images/firstfive.png') }}"></a>

                            <h5>Up your Productivity and Quality Stats<br>
                    (while reducing Risk, Rework and Waste)<br>
                    by firming up CM Level 2 processes.</h5>
                            <br>
                            <h5>Do this for Traditional Project Management processes or
                    <a href="/home/agile">Agile processes</a>.<br>Then, <a href="/cmmi" >with
                      a managed CM Level 2 base
                      firmly in place</a>; reach higher. </h5>
                            <table style="width: 70%" border="2" align="center">
                                <tr>
                                    <td>
                                        <p align="center"><i>Click the image above to go to the Capability Maturity Model.<br>
                            Can you appreciate that <a href="/cmmi" >CM Level 2</a> contains the project
                            management processes found in the <a href="/pmway/?slide=1" >PMBOK 6 dashboard</a>?<br>
                            And guess what... They are also found in <a href="/agile" >agile!</a><br>
                            <a href="/home/scrumdashboards#processes" >Can you spot them
                    ...
                    rapidly<br> &quot;Up Your Game Stats&quot; for CM L2+</h6>
                            ...
                            <a href="/home/gamestats" title="Click here for information about upping production statistics and red bead removal"><img alt="Red Beads" class="img-fluid" src="{{ asset('storage/images/redbeadsoutsmall.png') }}"></a>
        ...
        <!--
        <p align="center">
        <a href="/home/carousel?slide=2" title="Connect the Dots for the PMBOK's position within the bigger picture - understood by professionals that get it!"><img alt="" class="img-fluid" src="{{ asset('storage/images/canyouconnectthedotssmall.png') }}" ></a></p>-->
        ...
        <div class="rTableBody">
            <div class="rTableRow">
                <div class="rTableCell"></div>
                <!--<div class="rTableCell"><img class="img-fluid" src="{{ asset('storage/images/howdoyoudown.png') }}"  title="Have you documented and are you managing and optimizing your value chains in your Service Portfolios?"></div>-->


                <div class="rTableCell" align="center"><img class="img-fluid" src="{{ asset('storage/images/howdoyoudown.png') }}"  title="Have you documented and are you managing and optimizing your value chains in your Service Portfolios?" onmouseover="this.src='{{ asset('storage/images/itil4game.png') }}'" onmouseout="this.src='{{ asset('storage/images/howdoyoudown.png') }}'" >
                    <!--<div class="rTableCell"><img class="img-fluid" src="{{ asset('storage/images/howdoyou.png') }}" onmouseover="this.src='{{ asset('storage/images/howdoyoudown.png') }}'" onmouseout="this.src='{{ asset('storage/images/howdoyou.png') }}'" title=""></div>-->
                    <div class="rTableCell"></div>
                </div>
            </div>
            ...
            <button class="btn align-center clearfix" type="button" data-toggle=
                "collapse" data-target="#collapseperformancestats111" aria-expanded="false" aria-controls=
                    ...
                    <div class="rTableBody">
                        <div class="rTableRow">
                            <div class="rTableCell"></div>
                            <div class="rTableCell" align="center"><img class="img-fluid" src="{{ asset('storage/images/itilvaluestreams.png') }}" >
                            </div>
                            <div class="rTableCell"></div>
                        </div>
                    </div>
            ...
            <div class="collapse" id="collapseperformancestats">
                <div class="container">
                    <div class="card text-center">
                        <h3 class="card-header" align="center">The ITIL 4 Value Stream<br>Underpinned by Software Engineering with Lean, Devops, <a href="/pmway/?slide=1" >TPM</a> or <a href="/home/agile" >APM</a></h3>



                        <div class="card-body text-center">

                            <h5><a href="{{ asset('storage/assets/itilfouroverview.pdf') }}"  title="Click here for a presentation about ITIL 4">Click here for a quick overview of ITIL 4<br>and their handling of the Value Stream</a><br>Remember underpinning and supporting DevOps is ITIL best practice!</h5>
                            ...
                            <p>The above said, ultimately it is all about you being able to "Up" your Productivity and Quality Stats<br>
                                (while reducing Risk, Rework and Waste)<br>
                                This goal is achieved by <a href="/cmmi" >firming up CM Level 2 processes</a>.</p>
                            <p>Do this for <a href="/pmway/?slide=1" >Traditional Project Management processes</a> or
                                <a href="/home/agile">Agile processes</a>.<br>Then, <a href="/cmmi" >with
                                    a managed CM Level 2 base
                                    firmly in place</a>; reach higher. </p>
                            <p><a href="/pmway/?slide=2" >Connect the dots here</a> to see touchpoints on your journey towards success.</p>
                                    ...
                                    <div class="card text-center">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <table style="width: 70%" border="2" align="center">
                                                <tr>
                                                    <td>
                                                        <p align="center"><i><a href="/cmmi" >Click here to go to the Capability Maturity Model</a>.<br>
                                                                Can you appreciate that <a href="/cmmi" >CM Level 2</a> contains the project
                                                                management processes found in the <a href="/pmway/?slide=1" >PMBOK 6 dashboard? </a><br>
                                                                And guess what... They are also found in <a href="/agile" >agile!</a><br>
                                                                <a href="/home/scrumdashboards#processes" >Can you spot them
                                            ...
                                            <a href="/home/gamestats" title="Click here for information about upping production statistics and red bead removal"><img alt="Red Beads" class="img-fluid" src="{{ asset('storage/images/redbeadsoutsmall.png') }}" style="z-index:999"></a>
                                            <!--<br><i>for ideas start producing value!</i></p>-->
                        ...
                        <div class="card-footer">
                            ...
                            <h3 align="center">       <b>Are you a <a href="https://pmway.hopto.org/gamestats#kkahnli" >Kha Khan</a>?</b><br>

                                <a href="/home/fish" ><img class="verticalalign img-fluid" src="{{ asset('storage/images/fishsmaller.png') }}" title="Click here if you are tired of the chaos!"></a><br>
                                <b>Are you tired of the <a href="{{ asset('storage/assets/chaos-report.pdf') }}"  title="Click here for one of the original Chaos Reports.  Sound familiar?">Chaos</a>?</b>
                                <br>
                            </h3>
                        </div>
            ...
            <div align="center"><a href="/laws"   ><img class="img-fluid" src="{{ asset('storage/images/itil4gp2.png') }}" onmouseover="this.src='{{ asset('storage/images/itil4gp1.png') }}'" onmouseout="this.src='{{ asset('storage/images/itil4gp2.png') }}'" title="hover for more on ITIL 4 and their Guiding Principles or click for the importance of Millars Law"></a></div><br>
            ...
            <div align="center">
                ...
                <button class="btn align-center clearfix" type="button" data-toggle=
                    "collapse" data-target="#collapsecapmatlvl" aria-expanded="false" aria-controls=
                        ...
                        <div class="rTableBody">
                            <div class="rTableRow">
                                <div class="rTableCell"></div>
                                <div class="rTableCell"><img alt="" title="Click the gateway to see why Capability Maturity Level 2 is where you have to be in order to up your game stats and also to stop the chaos.  CM Level 2 is the firm base needed for CM L3, 4 and 5!" class="img-fluid" src="{{ asset('storage/images/gatewayflat.png') }}" onmouseover="this.src='{{ asset('storage/images/gateway.png') }}'" onmouseout="this.src='{{ asset('storage/images/gatewayflat.png') }}'"></div>
                                <div class="rTableCell"></div>
                            </div>
                        </div>
                    </div>

                </button><a href="/pmway/?slide=5"><img id="target" class="img-fluid" title="Click the target for the project management and other processes to maintain and improve up to Capability Maturity Level 5" src="{{ asset('storage/images/targetsmall.png') }}" alt="target" ></a>
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body text-center">
                                ...
                                <h5 align="center">Achieve Business Value through Productivity and Quality
                                    ...
                                    (<a href="/pmway/?slide=1">Traditional</a> or <a href="/home/agile"> Agile</a>) <br>
                                ...
                                <button class="btn btn-primary align-center clearfix" type="button" data-toggle=
                                    "collapse" data-target="#collapsepractice" aria-expanded="false" aria-controls=
                                            "collapsepractice">Process Focus<br><img class="img-fluid" src="{{ asset('storage/images/unlock.png') }}" title="Read the quotes from Dr Deming here to understand that a focus on processes is the only sure way to escape Capability Maturity Level 1 and below, in order to increase Productivity an Quality at CM L2 and above.">
                                        ...
                                        <div class="card text-center">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <div class="rTable">
                                                    <div class="rTableBody">
                                                        <div class="rTableRow">
                                                            <div class="rTableCell"><p>It (<a href="/cmmi" >CM Level 2+</a> as differentiated from CM L1 and below)<br> is all about Process Focus and thereby Productivity & Quality improvements <br>(quality outputs from the processes)<br><br><i>Hover your mouse over the images below <br>or click them to find out more about why process focus is really important for success.</i></p></div>
                                                            <div class="rTableCell" ><a href="/home/processnotoutcome"  ><img class="img-fluid" title="Click there to understand the zen of why it is a good idea to rather focus on process than outcomes" src="{{ asset('storage/images/demingone.jpg') }}" onmouseover="this.src='{{ asset('storage/images/demingtwo.jpg') }}'" onmouseout="this.src='{{ asset('storage/images/demingthree.jpg') }}'" title=""></a><br><br>
                                                                <p><a href="/redbeads" >Click here for Dr. Deming's Red Bead Experiment</a>.<br>
                                                                    This is an essential concept to learn if you aim for higher levels of <a href="/gamestats" >Productivity</a> and Quality and to be agile and lean.</p><h3>
                                                    ...
                                                    <div class="rTableBody">
                                                        <div class="rTableRow">
                                                            ...
                                                            <div class="rTableCell" >
                                                                ...
                                                                <p>Example of automation in a Value Stream<br>"Grain In and Meal Out"</p><a href="/images/largegrist.gif"  ><img class="img-fluid" src="{{ asset('storage/images/smallgrist.gif') }}"  title="Input (Grain), Transformation (Grinding of grist Process), Output (Meal or Flour)"></a>
                                                                ...
                                                                <div class="collapse" id="collapseprocesstiming">
                                                                    <div class="container">
                                                                        <div class="card text-center">
                                                                            <h5 class="card-header" align="center"><img class="img-fluid" src="{{ asset('storage/images/lordkelvin.jpg') }}"></h5>
                                                                            <div class="card-body text-center">


                                                                                <p align="center"><img class="img-fluid" src="{{ asset('storage/images/processtiming.jpg') }}"></p>
                                                                                <br>
                                                                                <p align="center"><img class="img-fluid" src="{{ asset('storage/images/herbieandleanswwastes.jpg') }}"></p>
                                                                                <br>


                                                                                <p align="center"><a href="/home/littleslaw" >Click here for Little's Law</a></p>
                                                                                <p align="center"><a href="/home/scrumorkanban" >Click here for an excellent article about Scrum or Kanban (or ScrumBan).  <br>PMWay's opinion is found at the bottom.</a></p>
                                ...
                                <img class="img-fluid" src="{{ asset('storage/images/cmmproject2plus.png') }}" onmouseover="this.src='{{ asset('storage/images/cmmproject2plusshadedbezelled.png') }}'" onmouseout="this.src='{{ asset('storage/images/cmmproject2plus.png') }}'" title="Register with PMWay and let me help you find your way">

                                <p align="left">
                                    <a href="/pin"  title="Where is your game at. Drag the pin with your mouse upwards to the Capability Maturity model or click the pin to take the test"><img alt="" id="pin" height="144" src="{{ asset('storage/images/pinlarge.png') }}" width="152"></a>I.e. can you pin down where is your game is currently at?</p>
                                <br>
                                <h5 align="center">If you think the game has changed from Traditional Project Management to Agile Project Management<br>
                                    ...
                                    <img class="img-fluid" alt="mind the game with TPM and APM - or else" src="{{ asset('storage/images/tpmapmgap.png') }}" >

                                    <img class="img-fluid" alt="mind the game with TPM and APM - or else" src="{{ asset('storage/images/thegamelarger.jpg') }}" >
                                    <p align="left">In Agile (Scrum project method for example) the goal is to produce working softare regularly each sprint that meets the user requirement (<a href="/productincrement" target=_blank"><i><u>the art of slicing sprint delivery / product increment production</u></i></a>).  Requirements are accepted by the team as user stories into the current sprint.  Therefore the gap in Scrum typically, is a 2 week sprint!<br><br><b>Here are some important questions you may want to consider, if your aim is to operate with agility at Capability Maturity Level 2+:<br><ul align="left"><li>Can the team mind the gap releasing user stories as working software at the end of each sprint?  <br>I.e. <a href="/home/agile?slide=12" ><u>From the Agile Manifesto's two key principles which state:<br><br>
                                                            <ul>
                                                                <li></u></a> “Our highest priority is to satisfy the customer through early and continuous delivery of valuable software”</li>&amp<li>"Deliver working software frequently, from a couple of weeks to a couple of months, with a preference on the shorter timescale"</li></ul><br><i>Note: As the Scrum method can be used for all types of projects (not just software projects) <a href="/home/snowbird" ><u><br>Per the last 10 minutes of the discussion here</u></a> it is suggested that the word "software" can easily be swopped out for the word "value" <br>I.e. (in the Agile Manifesto's four value propositions:<br>  We are uncovering better ways of developing software by doing it and helping others do it.<br><a href="/home/agile?slide=12" ><u>Through this work we have come to value:...</u></a>)</i></li><li>Essentially, are the team a <a href="/images/doneandundone.jpg" >done or undone</a> Scrum team?</li><li>If an undone Scrum team, are they dealing with more and more <a href="/images/undonescrum.jpg" >undone work</a> piling up sprint after sprint?</li><li>What is this doing to the projects budget from an <a href="/images/tcpi.jpg" >Earned Value well managed</a> perspective?</li><li>If the above points (and more) are not appreciated then Agile will be "Fragile" and "AINO" or "Agile In Name Only" and (there is a very good probability that) the team will be operating heroically at Capability Maturity Level 1!</li></ul></b></p>
                                    <p><a href="{{ asset('storage/assets/scrumsafelyfordownload.pdf') }}" >Also click here for Scrum SAFely pdf</a></p>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn align-center clearfix" type="button" data-toggle="collapse" data-target="#collapseopencarousel" aria-expanded="false" aria-controls="collapseopencarousel">
                    <div class="rTableBody">
                        <div class="rTableRow">
                            <div class="rTableCell"></div>
                            <div class="rTableCell" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img alt="Animated GIF of Cogs going around and around to illustrate the idea of processes working together" height="50" src="{{ asset('storage/images/cogsworking.gif') }}" width="73"  title="Click on the cogs and understand more about how processes can be used to up your production stats"></div>
                            <div class="rTableCell"></div>
                        </div>
                    </div>
                </button>
                <div class="collapse" id="collapseopencarousel">
                    <div class="container">
                        <div class="card text-center">
                            <h5 class="card-header" align="center"><a href="/home/cmmi" >Capability Maturity Level 2</a> is
                                essentially all about Project Management processes <br><!--<a href="/home/itilpractices"  >--><img class="img-fluid" title="value streams" src="{{ asset('storage/images/itosmallabove.png') }}" onmouseover="this.src='{{ asset('storage/images/itosmall.png') }}'" onmouseout="this.src='{{ asset('storage/images/itosmallabove.png') }}'" title=""><!--</a>--><br>

                                Else operating @ CM L1<!--<br><a href="/pmway/?slide=1" ><em style="font-size:small">I.e. rush heroically into
PMBOK 6 process #4.3,<br>or <a href="/pmway/?slide=12" >Scrum process #13</a><br>before receiving the tailored outputs required from the previous processes;
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active" align="center">
                                        ...
                                        <div class="container-flex" style="max-width:70%;">
                                            ...
                                            <!--<img class="img-fluid" alt="" src="{{ asset('storage/images/dashheadsmaller.png') }}"  >-->
                                            <img alt="" class="img-fluid" style="z-index:1" src="{{ asset('storage/images/dashheadflat.png') }}" onmouseover="this.src='{{ asset('storage/images/dashheadraised.png') }}'" onmouseout="this.src='{{ asset('storage/images/dashheadflat.png') }}'">
                                            <br>
                                            ...
                                            <a href="/home/demoitto">
                                                ...
                                                <img alt="" class="img-fluid" style="z-index:0" src="{{ asset('storage/images/mainprocessdashraisednormalflat.png') }}" onmouseover="this.src='{{ asset('storage/images/mainprocessdashraisednormalbezelledone.png') }}'" onmouseout="this.src='{{ asset('storage/images/mainprocessdashraisednormalflat.png') }}'" title="Click the hand (process 4.1) to see a demo of the itto dashboard for PMBOK Process 4.1"></a>
                                                    ...
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            <p>The new Project Management Body of Knowledge Guide (released September 2017)
                                                                ...
                                                                <br>
                                                                <a href="/home/thegame"  title="Click the tile for a larger (more detailed) image of how to play the game">
                                                                    <img alt="The game" class="img-fluid"  id="game" src="{{ asset('storage/images/TheGame.png') }}" ></a>
                                                            ...
                                                            <p>Oh, also... do not forget that the PMBOK operates as a Standard!
                                                                ...
                                                                <br> as you <b>&quot;<a href="/pmway/?slide=2" ><u>connect the dots</u></a>&quot;</b> below.</p>
                                                            <p>A quick note to those <a href="/pin"  title="Take the pin test now to see where your game is at">"Traditional" is not "Agile"</a> out there.
                                                                ...
                                                                <br><b>&quot;<a href="/home/agile?slide=10"
                                                                                ><u>a two week sprint!</u></a>&quot;</b>

                                                                <br>
                                                                <br> Operating thus, as a Professional who understands Project Management Process,
                                                                <br>(supported by your Executive [Executive Action Team (to EAT &quot;<a href="/home/removetheredbeads" >the
                                                                    red beads,</a>&quot;)])
                                                                <br>using
                                                                <a href="/home/agile?slide=13" >
                                                                    best selected project methodology</a>,
                                                                <br>there is less chance of dropping the ball.</p>

                                                            <img alt="drop the ball" class="img-fluid" src="{{ asset('storage/images/droptheball.png') }}">
                                                            <br>
                                                            ...
                                                            <!--<a href="/home/removetheredbeads"  title="Click the image to find out how and why to remove the Red Beads"><img alt="" class="img-fluid" src="{{ asset('storage/images/redbeadremoved.png') }}"></a>-->
                                                        </div>
                                                        <div class="card-footer">
                                            ...
                                            <a href="/login"  title="Find out about the concepts of Freedoms, Barriers and Goals and how they can be made to work together for success">Freedoms, Barriers, Goals</a> and <a href="/images/anyroad.jpg"  title="Find out that if you do not know what your destination is, any road will take you there.  I.e. anywhere, nowhere!">Destinations</a>
                                        ...
                                        <div class="container" style="max-width:70%">
                                            <h5><strong>Standards, Frameworks and Methodologies etc., by focus area</strong><br>
                                                <em>Note that the PMBOK is a <a href="https://www.pmi.org/pmbok-guide-standards/foundational"
                                                                                ><b><u>Standard</u></b></a>!</em></h5>

                                            <p><img class="img-fluid" src="{{ asset('storage/images/standardsframels.png') }}" ></p>


                                            <p><img class="img-fluid" src="{{ asset('storage/images/pptone.png') }}" ></p>
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        <h5 class="card-header" align="center">Can you find Time (Schedule), Cost, Scope <br>Knowledge Areas
                                                            <br><a href="/pmway/?slide=1"><u>on the PMBOK 6 Dashboard</u></a>?<br>Do you know that Quality <br>is tied
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <img alt="Time Cost Scope and Quality" class="img-fluid" src="{{ asset('storage/images/timecostquality.png') }}">
                                                            <br>
                                                            <br>
                                                            <img alt="" class="img-fluid" src="{{ asset('storage/images/6%20constraints.jpg') }}">
                                                            <br>
                                                            <p>Here is the game!
                                                                <br> Can you see it?</p>
                                                            <br>
                                                            <img alt="Core and Facilitating functions" class="img-fluid" src="{{ asset('storage/images/corefacilitate1.png') }}">
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <!-- <img class="img-fluid" src="{{ asset('storage/images/standardsframels.png') }}" onmouseover="this.src='{{ asset('storage/images/pptone.png') }}'" onmouseout="this.src='{{ asset('storage/images/standardsframels.png') }}'">-->
                                                            ...
                                                            <img alt="horse race" class="img-fluid" src="{{ asset('storage/images/horsewellridden.png') }}">
                                                            ...
                                                            <p>Unlike Business As Usual (BAU) a project is a temporary undertaking!
                                                                <br>In essence, via the project, you are <a href="/vmodel" ><u>jumping a gap</u></a> from one baseline to a new (improved) baseline (destination, goal etc.).</p>
                                                            ...
                                                            <p><b>Planning</b> and <b>Monitoring and Control</b> on either side of <b>Execution</b> ensures delivery and ultimately accountability to Stakeholders.
                                                                ...
                                                                <br>on the <a href="/pmway/?slide=1" ><u>PMBOK dashboard?</u></a>
                                                                <br>If interested <a href="/pmway/?slide=16"><u>Slide #16</u></a> has more information about how PDCA fits into this picture.
                                                                <br>
                                                            </p>

                                                        </div>
                                                        <div class="card-footer">(<a href="/home/agile?slide=12" ><u>The Agile debate
                                                                    notwithstanding...</u></a>)
                                                            <br>projects being managed for value are either reined and under control (delivering results)
                                                            <br>or they are not.
                                                            <br>
                                                            <img alt="out of control" class="img-fluid" src="{{ asset('storage/images/horse.png') }}" onmouseover="this.src='{{ asset('storage/images/horseoutofcontrol.jpg') }}'" onmouseout="this.src='{{ asset('storage/images/horse.png') }}'" title="How under control is your project really?">
                                                                ...
                                                                <div class="container">
                                                                    <div class="card text-center">
                                                                        ...
                                                                        <div class="card-body text-center">
                                                                            ...
                                                                            <img alt="" title="scrum governance" class="img-fluid" src="{{ asset('storage/images/scrumgovernance.png') }}">
                                                                            <p><a href="/home/scrumvaluemodel#demoapproved" >Click here for more on this</a> if interested.</p>
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <img class="img-fluid" src="{{ asset('storage/images/strategywall850.png') }}" "=" " onmouseover=" this.src='{{ asset('storage/images/legobrickbox.png') }}' " onmouseout=" this.src='{{ asset('storage/images/strategywall850.png') }}' " ">
                                            <br>
                                            <br>
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <a href="https://www.pmway.hopto.org/cv/paper.pdf#page=299" ><img alt="The PMIS" class="img-fluid" src="{{ asset('storage/images/engineanimated.gif') }}" title="Click the image for a paper motivating the Project Management Information Server as sure way to achieve CM Level 2 stability for Productivity and Quality gains. "></a>
                                                        </div>
                                                        <div class="card-footer">
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <a href="/cmmi" >
                                                ...
                                                <img class="img-fluid" src="{{ asset('storage/images/cmmproject2plus.png') }}" onmouseover="this.src='{{ asset('storage/images/cmmproject2plusshadedbezelled.png') }}'" onmouseout="this.src='{{ asset('storage/images/cmmproject2plus.png') }}'" title="Click the image for more information about Capability Maturity improvements."></a>
                                            ...
                                            <a href="/pin" title="Click to Pin down your Capability Maturity level now!  Or drag the pin through the gateway and hit the Productivity and Quality improvement target!"><img alt="pin" class="img-fluid" id="pintwo" src="{{ asset('storage/images/pinlarge.png') }}"></a>
                                            <br>
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <img class="img-fluid" src="{{ asset('storage/images/cmmiuplevels.png') }}">
                                                            <br>
                                                            ...
                                                            <img alt="" class="img-fluid" src="{{ asset('storage/images/cogsworking.gif') }}">
                                                            <hr>
                                                                ...
                                                                <div class="container">
                                                                    <div class="card text-center">
                                                                        ...
                                                                        <div class="card-body text-center">
                                                                            ...
                                                                            <a href="/pin" ><img class="img-fluid" src="{{ asset('storage/images/cmmi%20@%20level%201.png') }}" onmouseover="this.src='{{ asset('storage/images/danger.jpg') }}'" onmouseout="this.src='{{ asset('storage/images/cmmi%20@%20level%201.png') }}'"></a>
                                                                            <br>
                                                                            <br>
                                                                            <a href="/home/fail"  title="Click OOPS! now for more information on why projects fail"><img alt="oops" class="img-fluid" src="{{ asset('storage/images/oopsmall.png') }}"></a>
                                                                            <br>
                                                                            <img alt="" class="img-fluid" src="{{ asset('storage/images/car%20drives%20off%20road%20norm.png') }}">

                                                                            <p align="left">Just for fun <a href="/realstory" >click here</a> for the games @ CM Level 1.
                                                                                <br> If interested click OOPS! above for the 15 reasons why projects fail at CM Level 1.
                                                                                <br> And <a href="/pin" title="Click here for the real reason there is chaos out there!" >Traditional Project Management process often is blamed for the
                                                                                    chaos</a>!?
                                                                                <br> Agile methods touted as the solution but operated at CM Level 1 will simply add to, and bring about increased
                                                                                <a href="{{ asset('storage/assets/chaos-report.pdf') }}" >chaos</a>!</p>
                                                                        </div>
                                                                        <div class="card-footer">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="card text-center">
                                                                        ...
                                                                        <div class="card-body text-center">
                                                                            ...
                                                                            <p style="text-align:center">
                                                                                <img class="img-fluid" src="{{ asset('storage/images/divertedresources.png') }}" onmouseover="this.src='{{ asset('storage/images/corruption.png') }}'" onmouseout="this.src='{{ asset('storage/images/divertedresources.png') }}'">
                                                                                <br>
                                                                        ...
                                                                        <div class="card-footer">
                                                                            ...
                                                                            <br>2500 years old...
                                                                            <br>
                                                                            <img alt="" class="img-fluid" src="{{ asset('storage/images/goose1.jpg') }}"><img alt="" class="img-fluid" src="{{ asset('storage/images/goose2.png') }}">
                                                                            ...
                                                                            <br>
                                                                            <br> <img alt="" class="img-fluid" src="{{ asset('storage/images/sceletalcowproject.jpg') }}">
...
<h5 class="card-header" align="center">South Africa operating  @ CM Level ZERO</h5>
            <div class="card-body text-center">
							<a href="/home/zaprobsol"  title="Any and all improvements to save South Africa must begin with the intention to move out of CM Level ZERO!  Click here to see this obvious truth for yourself"><img alt="south africa going nowhere" class="img-fluid"  src="{{ asset('storage/images/hippo.png') }}"></a>
					...
					Bottom Line:<br>
					<a href="/pin"  title="Click this image to take the pin test now."><img alt="Don't even know what they don't know" class="img-fluid"  src="	/images/mountstupidsolutionbase.jpg"></a>
...
-->
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <img alt="CMMi-Dev1.3 dashboard" class="img-fluid" src="{{ asset('storage/images/cmmi-dev1.png') }}">
                                            <br>
                                            <br>

                                            <img alt="cmmi all" class="img-fluid" src="{{ asset('storage/images/cmmimodelsall.jpg') }}">
                                            <br>
                                            <br>
                                            <p><a href="{{ asset('storage/assets/cmmioverview.pdf') }}" >CMMi 3.1 Overview</a></p>
                                            <p><a href="{{ asset('storage/assets/bestcmmi.pdf') }}" >CMMi 3.1 More Detailed Overview</a></p>

                                            <p><a href="{{ asset('storage/assets/cmmidevtools.pdf') }}" >CMMi 3.1 DevTools</a></p>
                                            <br>
                                            <br>
                                                    ...
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <p>The first step on your CMMi journey:
                                                                ...
                                                                <br>Then find these core processes <a href="/pmway/?slide=1" >on the PMBOK 6 dashboard</a>!
                                                                <br>And just for fun also find them
                                                                <a href="/scrum" >on the Scrum dashboard</a>.</p>
                                                        </div>
                                                        <div class="card-footer">
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        <h5 class="card-header" align="center">PDCA is the <img class="img-fluid" alt="" height="82"
                                                                                                                src="{{ asset('storage/images/beatingheart.gif') }}" width="60"> of CMMi<br> and the CM Model.</h5>
                                                        <div class="card-body text-center">
                                                            <p>Deming's Plan, Do, Check, Act (PDCA) cycle is the secret of Continual Service Improvement to achieve quality improvements.
                                                                <br>This is tied to the concept of <a href="{{ asset('storage/assets/kaizen.pptx') }}">(kaizen)</a>.</p><img alt="" class="img-fluid" src="{{ asset('storage/images/pdca_process.png') }}">
                                                            <br>
                                                            <br>
                                                            <p>Can you see how the image below ties back <a href="/pmway/?slide=1">to the PMBOK 6 dashboard</a>?</p><img alt="" class="img-fluid" src="{{ asset('storage/images/qualitymodels.png') }}">
                                        ...
                                        <div class="container" style="max-width:70%">
                                            <h5>
                                                ...
                                                <strong>The People - Process - Technology Triad<br>Do you (can you?) "<a href="/home/removetheredbeads"
                                                                                                                         >Remove the Red Beads</a>"?</strong></h5>
                                            <p><i>Click the image to get the importance of this!</i></p>

                                            <p align="center"><img class="img-fluid" src="{{ asset('storage/images/peopleprocesstechbeads.jpg') }}" onmouseover="this.src='{{ asset('storage/images/peopleprocessbottomline.png') }}'" onmouseout="this.src='{{ asset('storage/images/peopleprocesstechbeads.jpg') }}'"></p>
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <p align="center"><img class="img-fluid" src="{{ asset('storage/images/vmodelbevel.png') }}" onmouseover="this.src='{{ asset('storage/images/itilvaluecreation.jpg') }}'" onmouseout="this.src='{{ asset('storage/images/vmodelbevel.png') }}'"></p>
                                            <p><i>On the image above<br>find Configuration (Configuration Management (CM)), Verification
                                                    ...
                                                    <a href="/pmway/?slide=5">Now click here</a>.  Can you find CM, VER, VAL and REQM on the CMMi Dev table?  What are their CM Levels?</i></p>
                                            ...
                                            <p><i>Hover over the image below to get the importance
                                                    ...
                                                    die!</i></p>
                                            <a href="{{ asset('storage/assets/tarpitchapter.pdf') }}"  title="Click the image to download the milestone Chapter by Frederick Brooks.  Avoid the dangers of the tarpit.  Mind the Gap!"><img alt="" class="img-fluid" src="{{ asset('storage/images/gap55wider.jpg') }}" onmouseover="this.src='{{ asset('storage/images/tarpitstwo.jpg') }}'" onmouseout="this.src='{{ asset('storage/images/gap55wider.jpg') }}'"></a>
                                            <!--<img class="img-fluid" src="{{ asset('storage/images/gap55wider.jpg') }}">-->
                                            <br>
                                            <br>
                                                    ...
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            <p align="left">Bidirectional Traceability of Requirements is at the heart of (Requirements Management [REQM] &amp; Configuration Management [CM]).
                                                                <br>
                                                                <br><a href="/pmway/?slide=5">Can you find REQM &amp; CM on the CMMi Dev Dashboard? <br>What is the
                                                                ...
                                                                <br>( <a href="/agileisdead" >Latest agile thinking here agrees with this
                                                                    approach</a>)
                                                                <br>
                                                                <br>Finally, can you see that this side of the Gap is where you (software developers / <a href="/pmway/?slide=8" >ITIL Service Designers</a>) are now.
                                                                ...
                                                                <br>After UAT sign off <a href="/pmway/?slide=8"  title="Click here for information on SO in PMWay's ITIL page">Service Operations</a> must take over, maintaining the working system
                                                                <br>while Service Strategy and Service Design look at next versions of <a href="/workingsoftware" >Working Software</a>.</p>
                                                        </div>
                                                        <div class="card-footer">
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            <h5>
                                                ...
                                                <br>(<a href="{{ asset('storage/assets/itilfouroverview.pdf') }}"  title="Click here for a presentation about ITIL 4">Transitioning to ITIL 4: 1000 foot overview</a>)</h5>
                                            <p><img alt="ITIL" class="img-fluid" src="{{ asset('storage/images/itil_v321.png') }}"></p>
                                            <p><img alt="ITIL Books" class="img-fluid" src="{{ asset('storage/images/itilstageswithbooks.png') }}"></p>
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <p><a href="/home/itiloverview"  title="Click here for the ITIL V3 processes"><img class="img-fluid" alt="Click here for the v3 processes" src="{{ asset('storage/images/itil3a.png') }}" ></a></p>
                                            ...
                                            <p><a href="/home/itiloverview"  title="Click here for the ITIL V3 processes"><img class="img-fluid" alt="Click here for the v3 processes" src="{{ asset('storage/images/itiloverview20191217smaller.jpg') }}" ></a>


                                                <br>
                                                <!-- <a href="{{ asset('storage/assets/itil.jpg') }}" title="Download this Itil image with non-transparent background.  " > <img class="img-fluid" alt="itil with pain points" src="{{ asset('storage/images/itilwithpainpoints20171018.png') }}"></a>-->
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <p align="center"><img class="img-fluid" src="{{ asset('storage/images/itilpainpoints.jpg') }}"> </p>

                                                            <br>
                                                            <br>
                                                            <h1>I.e.</h1>

                                                            <p align="center"><img class="img-fluid" src="{{ asset('storage/images/itilvaluestreams.png') }}"  title="Do you know what your value streams are?  Can you place them on a BCG Growth Share Matrix?"></p>
                                                            <br>
                                                            <br>
                                                            <p align="center"><img class="img-fluid" src="{{ asset('storage/images/bcg.jpg') }}"  title="Do you know what your value streams are?  Can you place them on a BCG Growth Share Matrix?"></p>
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <p align="center">
                                                <a href="/accelerate"  title="Click here for the 24 capabilities and way to install Devops (eat the elephant)!"><img alt="" class="img-fluid" src="{{ asset('storage/images/devopsimage.png') }}" onmouseover="this.src='{{ asset('storage/images/devopscogs.png') }}'" onmouseout="this.src='{{ asset('storage/images/devopsimage.png') }}'"></a>
                                            </p>

                                            <p align="center">
                                                <a href="/accelerate"  title="Click here for the 24 capabilities and way to install Devops (eat the elephant)!"><img alt="Its DevOps" class="img-fluid" src="{{ asset('storage/images/itsdevops.png') }}"></a>
                                            </p>
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <p align="center"><img alt="" class="img-fluid" src="{{ asset('storage/images/devopsuncertain.png') }}" onmouseover="this.src='{{ asset('storage/images/devandops.png') }}'" onmouseout="this.src='{{ asset('storage/images/devopsuncertain.png') }}'" title="Click the image now to reduce Devops uncertainty"></p>
                                                            <img alt="PO are the new RM's" class="img-fluid" src="{{ asset('storage/images/poarenewrm.png') }}">
                                                            <br>
                                                            <br>
                                                                    ...
                                                                    <div class="card text-center">
                                                                        ...
                                                                        <div class="card-body text-left" align="left">
                                                                            ...
                                                                            <p align="left">Thanks Abhinav (page 294)
                                                                                <br> PS <a href="/pmway/?slide=10" >I am reminded by the above of the importance of the Board
                                                                ...
                                                                <div class="container">
                                                                    <div class="card text-center">
                                                                        ...
                                                                        <div class="card-body text-center">
                                                                            ...
                                                                            <img alt="Scrum Value Model" class="img-fluid" src="{{ asset('storage/images/scrumvaluemodelroles.jpg') }}">
                                                                            <br>
                                                            ...
                                                            <p>DevOps is <a href="/home/index?slide=8">ITIL</a>, just empowered for speed!
                                                                <br>Scrum team sprints (as an example) must be able to <a href="/release" >release</a>
                                                                <a href="/workingsoftware" >working software</a> faster.</p>

                                                            <p>
                                                                <a href="/pmway/?slide=8"><img alt="dev ops is itil but faster!" class="img-fluid" src="{{ asset('storage/images/itilppsdevopsmodel.jpg') }}" onmouseover="this.src='{{ asset('storage/images/itil.jpg') }}'" onmouseout="this.src='{{ asset('storage/images/itilppsdevopsmodelsinglesource.jpg') }}'" title="DevOps is ITIL, just empowered to be faster!"></a>
                                                            </p>
                                                            <p>DevOps/ITIL/Agile/Scrum etc., Goal: Release Working Software faster!</p>
                                                            <p>
                                                                <a href="/scrumrca#indexc" title="Click here and find the Un-Done Scrum image.  Putting this DevOps/ITIL/ solution into place can remedy Un-Done Scrum and other Scrum Dysfunctions" ><img alt="Release Working Software Faster" class="img-fluid" src="{{ asset('storage/images/itildevopsmall.png') }}"></a>
                                                            </p>
                                                            <p>Notice that for the pilots telemetry is either nominal or not!</p>
                                                            <p align="center"><img class="img-fluid" src="{{ asset('storage/images/devopsrelease.jpg') }}"></p>
                                                            <p><a href="/scrumrca#indexc"  title="Click here for the 7 Scrum Dysfunctions of which Un-Done Scrum is one">If you can't do the above in Scrum you may become Un-Done!</a></p>
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <img class="img-fluid" src="{{ asset('storage/images/prince2processmodelwithbriefcase.jpg') }}" "=" " onmouseover=" this.src='{{ asset('storage/images/prince2modelprocwhereagilehappens.png') }}' " onmouseout=" this.src='{{ asset('storage/images/prince2processmodelwithbriefcase.jpg') }}' " ">
                                            ...
                                            <a href="/home/agile?slide=11"  title="Click here for more on the agile Methods. The Agile Manifesto section - especially project selection matrix - explains this image in more detail."><img alt="" class="img-fluid" src="{{ asset('storage/images/tradagilep2a.png') }}"></a>
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <img alt="DSDM Model" class="img-fluid" src="{{ asset('storage/images/dsdmorig20160712.png') }}">
                                            <br>
                                            <br>

                                            <p><i>The image below shows how agility can introduce risk. Can you see it?</i></p>
                                            <a href="/home/agile?slide=4"  title="Click here for more on the agile Methods. The Agile Manifesto section - especially project selection matrix - explains this image in more detail."><img alt="" class="img-fluid" src="{{ asset('storage/images/tradagiledsdm.png') }}"></a>
                                            <p><i>Click the image above for an overview of the different agile methods</i></p>
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <br><a href="/home/scrumsixmins" > <img class="img-fluid" src="{{ asset('storage/images/scruminsixmins.png') }}" title="Scrum in Just Six Minutes"></a><br>
                                            <a href="/scrum"  title="Click the image to go to an overfiew of Scrum method and its process.  If you are learning Scrum these form an overview of what you need to know."><img alt="sprint with PP and PMC" class="img-fluid" src="{{ asset('storage/images/Scrumprocessswirl.jpg') }}">
                                                <br>

                                                <img class="img-fluid" src="{{ asset('storage/images/scrumdashnochapters.png') }}" title="From the Scrum Body of Knowledge 3rd edition"></a>
                                            <br>
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        <p class="card-header" align="center">Note below how value is produced in agile's Scrum method.
                                                            <br> Note also the importance of the <a href="/reinventingitil" >Product Owner, ITIL and Devops</a>.</p>
                                                        <div class="card-body text-center">
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <a href="{{ asset('storage/assets/scrumvaluemodelessence.pdf') }}" ><img alt="Scrum Value Model essence" class="img-fluid" src="{{ asset('storage/images/scrumvaluemodelessence.jpg') }}" title="Click the image to download a pdf"></a><br>
                                            ...
                                            <br>
                                            <p><i>The image below shows how agility can introduce risk. Can you see it?</i></p>
                                            <a href="/home/agile?slide=10"  title="Click here for more on the agile methods. The Agile Manifesto section - especially project selection matrix - explains this image in more detail."><img alt="" class="img-fluid" src="{{ asset('storage/images/tradagilescrum.png') }}"></a>
                                            <p><i>Click the image above for an overview of the different agile methods</i></p>
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <p>
                                                <a href="/home/safe"  title="Click the image for a short video about Safe"> <img class="img-fluid" src="{{ asset('storage/images/safe.png') }}" "=" " onmouseover=" this.src='{{ asset('storage/images/safeart.png') }}' " onmouseout=" this.src='{{ asset('storage/images/safe.png') }}' " "></a>
                                                Click the image above for a short video on SAFe. </p>
                                            <p><a href="{{ asset('storage/assets/scrumsafelyfordownload.pdf') }}" >Click here for Scrum SAFely pdf</p>
                                            <br>
                                                          ...
                                                          <div class="card text-center">
                                                              ...
                                                              <div class="card-body text-center">
                                                                  <p align="left">Can you see that SAFe is simply a bunch of consolidated Scrums?
                                                                      ...
                                                                      <br>(<a href="/vmodel" >I.e. "Working Software Demo" to next "Working
                                            Software Demo"</a> in <a href="/productincrement" >product increments</a>!)</p>
                                                                      ...
                                                                      <div class="container">
                                                                          <div class="card text-center">
                                                                              ...
                                                                              <div class="card-body text-center">
                                                                                  ...
                                                                                  <p align="left">Can your sprints actually deliver (<a href="/release" >release</a>) new versions of
                                                                                      <a href="/workingsoftware" >working software</a> into production after a sprint (number of sprints)?
                                                                                      <br>
                                                                                      <br>Based on agreed User Stories moved to the sprint from the groomed backlog, does the Product Owner agree that working software has improved the specific <a href="/vmodel" >system software baseline</a> for <a href="/itil" >"particular IT Infrastructure stack"</a> and software can now be <a href="/release" >released (Dev=>QA=>UAT=>)</a> into production?
                                                                                      <br>
                                                                                      ...
                                                                                      <a href="/pmway/?slide=1" >per
                                                    the dashboard on the home page</a>)
                                                                                      <br><b>as fingers and thumb, <br>squeeze out
                                                    Production (Project Execution)</b>.
                                                                                      <br>This "pressure" to "release" on demand (like needing toothpaste from a tube) in the Scrum Method comes from dynamic tension as the <a href="{{ asset('storage/assets/productowner.pdf') }}"  title="Thank you F. M. Fowler">Product Owner</a> interacts with the <a href="{{ asset('storage/assets/scrummaster.pdf') }}"  title="Thank you F. M. Fowler">Scrum
                                                    Master</a> and <a href="{{ asset('storage/assets/scrumteam.pdf') }}"  title="Thank you F. M. Fowler">Scrum Team</a>.</p>
                                                                                  <img alt="squeeze toothpaste" class="img-fluid" src="{{ asset('storage/images/squeetube.jpg') }}">
                                                                                  <br>
                                                                                  <br>
                                                                                  <img alt="sprint with PP and PMC" class="img-fluid" src="{{ asset('storage/images/sprintmethodwithpppmc.jpg') }}">
                                                                                  <br>
                                                                                  <br><img alt="sprint with PP and PMC" class="img-fluid" src="{{ asset('storage/images/pppmcperscrumedited.png') }}">
                                                                                  <br>
                                                                                  <br><img alt="" class="img-fluid" src="{{ asset('storage/images/scrumprocessespppmcwitharrow.png') }}">
                                                                                  ...
                                                                                  <div class="collapse" id="collapsereinventing">
                                                                                      <div class="container">
                                                                                          <div class="card text-center">
                                                                                              <h5 class="card-header" align="center">Discussed in the <a href="/pmway/?slide=8" >ITIL page</a>, reiterated here due to its importance.</h5>
                                                                                              <div class="card-body text-left">

                                                                                                  <h5 align="left">DevOps is <a href="/home/index?slide=7">ITIL</a>, just empowered for speed!</h5>
                                                                                                  <p align="left">Scrum team sprints must be able to <a href="/release" >release</a>
                                                                                                      <a href="/workingsoftware" >working software</a> faster.</p>
                                                                                                  <p align="center">
                                                                                                      <a href="/accelerate"  title="Click here for the 24 capabilities and way to install Devops (eat the elephant)!"><img alt="dev ops is itil but faster!" class="img-fluid" src="{{ asset('storage/images/itilppsmaller.png') }}" title="DevOps is ITIL, just empowered to be faster!"></a>
                                                                                                  </p>
                                                                                                  ...
                                                                                                  <p align="left">The person who manages the entire release from end to end is the release manager and is still necessary. However, the release management role went from being a full-time position to a part-time one (statistically speaking), mainly because of the diminished work (thanks to automation). Capable release managers are
                                                                                                      ...
                                                                                                      <br>
                                                                                                      <p align="left">Thanks Abhinav (page 294)
                                                                                                          <br> PS <a href="/pmway/?slide=10" >I am reminded by the above of PRINCE2 Agile</a></p>
                                                                              ...
                                                                              <div class="card-footer">
                                                                                  FYI: Go to timestamp 22.50 <a href="/agileisdead" >in the video here</a>
                                                  ...
                                                  <br>-->
                                            <h3>Bottom line:</h3>
                                            <p><b><i>If your scrums are not <a href="/scrumvalued" >releasing valuable working software
                                                            regularly</a>;<br>then SAFe <br>(as with the problems [<a href="{{ asset('storage/assets/chaos-report.pdf') }}"
                                                                                                                      >and chaos</a>] associated with traditional project management)<br>
                                                        <a href="/pin" >if badly run at CM level 1</a><br>can be just as <a href="	/home/safeisunsafe" ><u>unsafe!</u></a></i></b>
                                            </p>

                                            <br><br>
                                            Therefore fix <a href="/scrum" >scrum first!</a></p>
                                            <!--END OF CONTENT-->
                                            <br>
                                            <br>
                                        </div>
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <!--<img alt="" class="img-fluid" src="{{ asset('storage/images/pcmmoverview.png') }}" >  -->
                                            <img alt="" class="img-fluid" src="{{ asset('storage/images/pcmmoverviewbevelled.png') }}">
                                            <br>
                                            <br>
                                            <button class="btn btn-primary align-center clearfix" type="button" data-toggle=
                                            ...
                                            <div class="collapse" id="collapsecats">
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <h5 class="card-header" align="center"><a href="/home/af" ><u>Consider American Football in the NFL</u></a></h5>
                                                        <p>
                                                            (Click the link
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <p>Now click the Shepherd below to see this from a Scrum Master's perspective. <br><a href="/pin">Click here</a> to pin down the problem and obvious solution. </p><img alt="" class="img-fluid" title="Click this image for an idea of what a Scrum Master must put up with at CM L1" src="{{ asset('storage/images/catastrophe.jpg') }}" onmouseover="this.src='{{ asset('storage/images/catastrophescrum.jpg') }}'" onmouseout="this.src='{{ asset('storage/images/catastrophe.jpg') }}'"><br>
                                                            <img alt="" class="img-fluid" src="{{ asset('storage/images/artofherdingcats.jpg') }}" ></div>
                                                        <div class="card-footer">
                                                    ...
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <p align="left">Agile postulates the "cohesive empowered professional team,"
                                                                ...
                                                                <br>
                                                                <br>Executive support [Executive Action Team (to EAT &quot;<a href="/home/removetheredbeads" >the red beads</a>&quot;)] is the key to success!
                                                                <br>As a test of this (and where the Executive need to <a href="/home/removetheredbeads" >remove the red beads</a>) [of which a lack of training in the team on what, when, why and how with regard to project processes to be followed will definitely create red beads],
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <img alt="" class="img-fluid" src="{{ asset('storage/images/11scobitprocessreferencemodel.png') }}">
                                            <br>
                                            <br>
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <br>I.e.
                                                            <img alt="eat the elephant" class="img-fluid" src="{{ asset('storage/images/elephant_one_bite.png') }}">
                                                            <br>
                                                            <br>
                                    ...
                                    <div class="carousel-item" align="center">
                                        <div class="container" style="max-width:70%">
                                            ...
                                            <p class="ctr"> <img alt="" class="img-fluid" src="{{ asset('storage/images/nopdcacycle.jpg') }}"></p>
                                                ...
                                                <div class="container">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <p><img alt="" class="img-fluid" src="{{ asset('storage/images/pdca_cycle.png') }}"></p>
                                                            <br>

                                                            <p align="left">Can you find PLAN, DO, CHECK (Monitor and Control) and ACT <a href="/pmway/?slide=1">in the PMBOK
                                                                    dashboard on the home page?</a>
                                                                <br> You can also <a href="#pdca">find it in the last image
                                                                    at the bottom of this page</a>!
                                                                <br> How about looking for it in <a href="/home/agile?slide=10" >Agile (Scrum)</a>
                                                                ...
                                                                <div class="container">
                                                                    <div class="card text-center">
                                                                        ...
                                                                        <div class="card-body text-center">
                                                                            ...
                                                                            <p align="left"><a href="/redbeads" >As W Edwards Deming taught us many years
                                                            ...
                                                            <p class="ctr">
                                                                <img alt="" class="img-fluid" src="{{ asset('storage/images/pdcacontinually.png') }}"></p>

                                                            <p class="ctr">
                                                                <a name="pdca"></a>
                                                                <img alt="" class="img-fluid" src="{{ asset('storage/images/qualitymodels.png') }}"></p>
                                                            <br>
                                                            <br>
                        ...
                        <div class="card-footer customcolorwhite">
                            <p align="center">
                                <a href="/pmway/?slide=2"  title="Click here to position the dashboard in a greater scheme, &quot;connecting the dots&quot; below"><img alt="" class="img-fluid" src="{{ asset('storage/images/canyouconnectthedotssmall.png') }}" ></a></p>
            ...
            <br>
            <img alt="" class="img-fluid" src="{{ asset('storage/images/cmltwoplus.png') }}"><br><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://pmway.hopto.org/itilfouroverview/index.html"  title="need some ideas on how to do this?"><img alt="presentation icon" title="need a high level presenation of ideas on how to do the above?" src="{{ asset('storage/images/presentationicon.png') }}"></a><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ asset('storage/assets/itilfouroverview.pdf') }}"  title="view presentation in pdf"><img alt="presentation icon" title="view a summary of the above presentation in pdf" target src="{{ asset('storage/images/pdf-iconlarger.png') }}"></a><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Accessible IT Strategy?</p>
            <br>
           <br>
        ...
        <div class="container">
            <div class="card text-center">
                <h5 class="card-header" align="center" id="jumptopmbokdash">User this dashboard to get at the PMBOK 6 processes.</h5>
                <div class="card-body text-center">
                    ...
                    <div class="collapse" id="collapseExample">
                      ...
                      may not work as expected.<br></h5>
                                <div class="card-body text-center">
                                    ...
                                    <p align="center"><img alt="" class="img-fluid" src="{{ asset('storage/images/pinch.png') }}" title="You can stretch the detail in smaller screens if done above or below the carousel"></p>
                                    ...
                                    <h1><a href="/home/levelonewheel" >Click for Level 1 Process
                          Selector Wheel</a></h1>
                                    <br>
                                    <br>
                                    <div align="center">
                                    ...
                                    <br>
                                    <br>
                                    <h1><a href="/home/leveltwowheel" >Click for Level 2 Process
      ...
      process group and knowledge area detail - by node)</span></h5>
                    ...
                    <map id="ImgMap3" name="ImgMap3">
                        <!--<area alt="" coords="0, 0, 93, 121" href="/home/pmboksix.pdf" shape="rect" >-->
                        <area coords="1, 2, 91, 121" href="/pmboksixsavepdf/pmboksixfull.pdf" shape="rect">
                    </map>

                    <img class="img-fluid" alt="" src="{{ asset('storage/images/dashhead.jpg') }}" usemap="#ImgMap3">
                    <br>
                    <br>
                    ...
                    <!--<img class="img-fluid" alt="Use this dashboard to get to grips with the Project Management Body of Knowledge -  PMBOK" height="1061" src="{{ asset('storage/images/mainprocessdashraised.png') }}" width="757" usemap="#ImgMap1" ><br>-->

                    <img class="img-fluid" alt="Use this dashboard to get to grips with the Project Management Body of Knowledge -  PMBOK" src="{{ asset('storage/images/mainprocessdashraised.png') }}" usemap="#ImgMap1">
                    <br>

                    <!--<map id="ImgMap2" name="ImgMap2">
                         <area coords="0, 4, 14, 16" href="/home/one.pdf" shape="rect" >
                         <area coords="16, 5, 29, 18" href="/home/two.pdf" shape="rect" >
                         <area coords="31, 5, 45, 16" href="/home/three.pdf" shape="rect" ></map><img alt="" height="19" src="/home/images/123.png" title="Chapter 1, 2 and 3 of the guide." usemap="#ImgMap2" >-->
                    <br>
                    <h5>This PMBOK Dashboard (the manual released September 2017) is fully
                        <a href="/home/agile" >Agile</a> compliant</h5>
                    <p>To that end see process 4.7.  I.e. Close Project, Phase (or sprint).<br>
                        To run Scrum (as a popular example of an agile method) <a href="/home/carousel?slide=4">at Capability Maturity Level 2+</a> <br><a href="/scrumvalued" >consider the model (and processes) found here</a>.<br>
    ...
    <br>
    <br>
    <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p align="center"><a href="https://pmway.hopto.org/itilfouroverview/index.html"  title="need some ideas on how to do this?"><img alt="presentation icon" title="need some ideas on how to do this?" src="{{ asset('storage/images/presentationicon.png') }}"></a><a href="{{ asset('storage/assets/itilfouroverview.pdf') }}"  title="view presentation in pdf"><img alt="presentation icon" title="view a summary of the above in pdf - note: full presentation is available if you are logged on" target src="{{ asset('storage/images/pdf-iconlarger.png') }}"></a></p>-->
