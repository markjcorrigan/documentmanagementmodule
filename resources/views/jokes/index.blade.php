            ...
            @can('joketable backup')
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="{{ route('jokes.backup') }}"
                               onclick="return confirm('Create a new backup of the jokes table?')">
                                <i class="bi bi-download"></i> Create New Backup
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('jokes.backups.list') }}">
                                <i class="bi bi-list"></i> View All Backups
                            </a>
                        </li>
                    </ul>
                </div>
