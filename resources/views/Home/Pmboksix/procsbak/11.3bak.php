...
<!--This is where the main stuff goes--->
	<h1 class="auto-style2">Perform Qualitative Risk Analysis<br />
	<span class="smltxt">PG Planning, KA Risk, #11.3</span></h1> <hr /> 
	...
	<area coords="39, 52, 71, 81" href="http://www.pmway.co.za/processesdash/11.4.php" shape="rect" title="down" />
	<area alt="" coords="0, 14, 36, 58" href="http://www.pmway.co.za/processesdash/prm.php" shape="rect" title="left" />
	<area alt="" coords="38, 24, 72, 51" href="http://www.pmway.co.za/processesdash/11.2.php" shape="rect" title="up" />
...
<img alt="" height="82" src="http://www.pmway.co.za/images/menulrdindex.png" width="111" style="float: left" usemap="#imgmap0" /><br />
	...
	<img alt="" height="1074" src="http://www.pmway.co.za/processesdash/imagesv6/ver611point3.png" width="842" usemap="#imgmap2" /> <br />
	
	<p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK 
	version 6 guide.</p>
		<img alt="" height="731" src="http://www.pmway.co.za/processesdash/imagesv6/113.png" width="641" /><br /><br /><p class="ctr">
		ITTO's as an image from the PMBOK version 6 guide.</p>	
	<img src="http://www.pmway.co.za/processesdash/images/mouseover.png"
 onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/113ittos.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
	</div>
	</div>
	
		
		<img src="http://www.pmway.co.za/processesdash/images/mouseover.png" onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/113flow.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
