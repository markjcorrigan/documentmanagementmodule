...
<!--This is where the main stuff goes--->
	<h1 class="auto-style2">Monitor and Control Project Work<br />
	<span class="smltxt">PG Monitoring and Controlling, KA Integration, #4.5</span></h1> <hr /> 
...
<img alt="" height="82" src="http://www.pmway.co.za/images/menulrdindex.png" width="111" style="float: left" usemap="#imgmap0" /><br />
	...
	<img alt="" height="1074" src="http://www.pmway.co.za/processesdash/imagesv6/ver64point5.png" width="842" usemap="#imgmap2" /> <br />
	
	<p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK 
	version 6 guide.</p>
		<img alt="" height="796" src="http://www.pmway.co.za/processesdash/imagesv6/45.png" width="638" /><br /><br /><p class="ctr">
 ...
 onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/45ittos.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
		...
		<img src="http://www.pmway.co.za/processesdash/images/mouseover.png" onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/45flow.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
