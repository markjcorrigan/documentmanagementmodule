...
<!--This is where the main stuff goes--->
	<h1 class="auto-style2">Close Project or Phase<br />
	<span class="smltxt">PG Closing, KA Integration, #4.7</span></h1> <hr /> 
	...
	<area coords="39, 52, 71, 81" href="http://www.pmway.co.za/processesdash/4.1.php" shape="rect" title="down" />
	<area alt="" coords="0, 14, 36, 58" href="http://www.pmway.co.za/processesdash/4.6.php" shape="rect" title="left" />
	...
	<area alt="" coords="35, 5, 75, 24" href="http://www.pmway.co.za/sitemap.php#dash" shape="rect" title="index"/>
		<area coords="76, 17, 109, 58" href="http://www.pmway.co.za/processesdash/4.1.php" shape="rect" />
	</map> 
<img alt="" height="82" src="http://www.pmway.co.za/images/menulrdindex.png" width="111" style="float: left" usemap="#imgmap0" /><br />
	...
	<img alt="" height="1074" src="http://www.pmway.co.za/processesdash/imagesv6/ver64point7.png" width="842" usemap="#imgmap2" /> <br />
	
	<p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK 
	version 6 guide.</p>
		<img alt="" height="974" src="http://www.pmway.co.za/processesdash/imagesv6/47.png" width="625" /><br /><br /><p class="ctr">
 ...
 onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/47ittos.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
		...
		<img src="http://www.pmway.co.za/processesdash/images/mouseover.png" onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/47flow.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
