...
<map id="imgmap2" name="imgmap2">
	...
	<p class="ctr"><img class="img-fluid" alt="" height="1074" src="http://www.pmway.co.za/processesdash/imagesv6/ver64point2.png" width="842" usemap="#imgmap2" /></p> <br />
	
	<p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK 
	version 6 guide.</p>
		<p class="ctr">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img class="img-fluid" alt="" height="463" src="http://www.pmway.co.za/processesdash/imagesv6/42.png" width="617" /><br /><br /><p class="ctr">
