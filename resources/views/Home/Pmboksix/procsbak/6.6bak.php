...
<!--This is where the main stuff goes--->
	<h1 class="auto-style2">Control Schedule<br />
	<span class="smltxt">PG Monitoring and Controlling, KA Schedule, #6.6</span></h1> <hr /> 
	...
	<area alt="" coords="0, 14, 36, 58" href="http://www.pmway.co.za/processesdash/6.5.php" shape="rect" title="left" />
	...
	<area alt="" coords="35, 5, 75, 24" href="http://www.pmway.co.za/sitemap.php#dash" shape="rect" title="index"/>
		<area coords="76, 17, 109, 58" href="http://www.pmway.co.za/processesdash/6.1.php" shape="rect" />
	</map> 
<img alt="" height="82" src="http://www.pmway.co.za/images/menulrdindex.png" width="111" style="float: left" usemap="#imgmap0" /><br />
	...
	<img alt="" height="1074" src="http://www.pmway.co.za/processesdash/imagesv6/ver66point6.png" width="842" usemap="#imgmap2" /> <br />
	
	<p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK 
	version 6 guide.</p>
		<img alt="" height="1134" src="http://www.pmway.co.za/processesdash/imagesv6/66.png" width="636" /><br /><br /><p class="ctr">
