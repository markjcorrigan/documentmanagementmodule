...
<div class="container">
	...
	<h5>PG Monitoring and Controlling, KA Quality, #8.3</h5><hr />
	...
	<area coords="39, 52, 71, 81" href="http://www.pmway.co.za/processesdash/9.6.php" shape="rect" title="down" />
	<area alt="" coords="0, 14, 36, 58" href="http://www.pmway.co.za/processesdash/8.2.php" shape="rect" title="left" />
	<area alt="" coords="38, 24, 72, 51" href="http://www.pmway.co.za/processesdash/7.4.php" shape="rect" title="up" />
	<area alt="" coords="35, 5, 75, 24" href="http://www.pmway.co.za/sitemap.php#dash" shape="rect" title="index"/>
		<area coords="76, 17, 109, 58" href="http://www.pmway.co.za/processesdash/8.3.php" shape="rect" />
	</map> 
<img alt="" height="82" src="http://www.pmway.co.za/images/menulrdindex.png" width="111" style="float: left" usemap="#imgmap0" /><br />
	...
	<img class="img-fluid" alt="" height="1074" src="http://www.pmway.co.za/processesdash/imagesv6/ver68point3.png" width="842" usemap="#imgmap2" /> <br>
<br>
	<p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK 
	version 6 guide.</p>
		<a href="http://www.pmway.co.za/v6/83.pdf#page=3">
		<img class="img-fluid"

 alt="" height="816" src="http://www.pmway.co.za/processesdash/imagesv6/83.png" width="626" /></a><br /><br /><p class="ctr">
 ...
 onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/83ittos.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
<br>
<br>
	
		
		<img class="img-fluid" src="http://www.pmway.co.za/processesdash/images/mouseover.png" onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/83flow.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
