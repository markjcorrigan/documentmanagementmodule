...
<div class="container">
	...
	<h5>PG Monitoring and Controlling, KA Scope, #5.5</h5><hr />
	...
	<area coords="39, 52, 71, 81" href="http://www.pmway.co.za/processesdash/5.6.php" shape="rect" title="down" />
...
<img alt="" height="82" src="http://www.pmway.co.za/images/menulrdindex.png" width="111" style="float: left" usemap="#imgmap0" /><br />
	...
	<img class="img-fluid" alt="" height="1074" src="http://www.pmway.co.za/processesdash/imagesv6/ver65point5.png" width="842" usemap="#imgmap2" /> <br><br>

	<p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK
	version 6 guide.</p>
		<a href="http://www.pmway.co.za/v6/55.pdf#page=3" >
		<img class="img-fluid"

 alt="" height="697" src="http://www.pmway.co.za/processesdash/imagesv6/55.png" width="622" /></a><br /><br /><p class="ctr">
 ...
 onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/55ittos.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
	<br>


		<img class="img-fluid" src="http://www.pmway.co.za/processesdash/images/mouseover.png" onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/55flow.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
