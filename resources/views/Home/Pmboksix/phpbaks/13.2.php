...
<div class="container">
	...
	<h3>Plan Stakeholder Engagement</h3>
	<h5>PG Planning, KA Stakeholders, #13.<span lang="en-za">2</span></h5><hr />
	...
	<area coords="39, 52, 71, 81" shape="rect" href="http://www.pmway.co.za/processesdash/13.2.php" />
	<area alt="" coords="0, 14, 36, 58" href="http://www.pmway.co.za/processesdash/13.1.php" shape="rect" title="left" />
	<area alt="" coords="38, 24, 72, 51" href="http://www.pmway.co.za/processesdash/12.1.php" shape="rect" title="up" />
	<area alt="" coords="35, 5, 75, 24" href="http://www.pmway.co.za/sitemap.php#dash" shape="rect" title="index"/>
		<area coords="76, 17, 109, 58" href="http://www.pmway.co.za/processesdash/13.3.php" shape="rect" />
		<area href="http://www.pmway.co.za/processesdash/13.3.php" shape="default" />
		<area coords="0, 0, 10000, 10000" href="http://www.pmway.co.za/processesdash/13.3.php" shape="rect" />
	</map>
<img alt="" height="82" src="http://www.pmway.co.za/images/menulrdindex.png" width="111" style="float: left" usemap="#imgmap0" class="auto-style1" /><br />
	...
	<img class="img-fluid" alt="" height="1074" src="http://www.pmway.co.za/processesdash/imagesv6/ver613point2.png" width="842" usemap="#imgmap2" /> <br>
<br>


	<p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK
	version 6 guide.</p>
		<a href="http://www.pmway.co.za/v6/132.pdf#page=3" >
	<img class="img-fluid"

 alt="" height="706" src="http://www.pmway.co.za/processesdash/imagesv6/132.png" width="640" /></a><br /><br /><p class="ctr">
...
<img class="img-fluid"src="http://www.pmway.co.za/processesdash/images/mouseover.png"
 onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/132ittos.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
	<br>



		<img class="img-fluid" src="http://www.pmway.co.za/processesdash/images/mouseover.png" onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/132flow.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
