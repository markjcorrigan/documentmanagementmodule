...
<div class="container">
	...
	<!--This is where the main stuff goes--->
	<h3>Develop Project Management Plan</h3>
	<h5>PG Planning, KA Integration, #4.2</h5><hr />
	...
	<area coords="39, 52, 71, 81" href="http://www.pmway.co.za/processesdash/5.1.php" shape="rect" title="down" />
	<area alt="" coords="0, 14, 36, 58" href="http://www.pmway.co.za/processesdash/4.1.php" shape="rect" title="left" />
	...
	<area alt="" coords="35, 5, 75, 24" href="http://www.pmway.co.za/sitemap.php#dash" shape="rect" title="index"/>
		<area coords="76, 17, 109, 58" href="4.3.php" shape="rect" />
	</map>
...
<map id="imgmap2" name="imgmap2">
	...
	<p class="ctr"><img class="img-fluid" alt="" height="1074" src="http://www.pmway.co.za/processesdash/imagesv6/ver64point2.png" width="842" usemap="#imgmap2" /></p> <br><br>

	<p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK
	version 6 guide.</p>
		<p class="ctr">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.pmway.co.za/v6/42.pdf#page=2" ><img class="img-fluid"

 alt="" height="463" src="http://www.pmway.co.za/processesdash/imagesv6/42.png" width="617" /></a><br /><br /><p class="ctr">
 ...
 onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/42ittos.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
<br><br>


		<img class="img-fluid" src="http://www.pmway.co.za/processesdash/images/mouseover.png" onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/42flow.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'"></p>
