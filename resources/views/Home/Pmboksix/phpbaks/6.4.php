...
<div class="container">
	...
	<h5>PG Planning, KA Schedule, #6.4</h5><hr />
	...
	<area coords="39, 52, 71, 81" href="http://www.pmway.co.za/processesdash/6.5.php" shape="rect" title="down" />
	<area alt="" coords="0, 14, 36, 58" href="http://www.pmway.co.za/processesdash/ptm.php" shape="rect" title="left" />
	<area alt="" coords="38, 24, 72, 51" href="http://www.pmway.co.za/processesdash/6.3.php" shape="rect" title="up" />
...
<img alt="" height="82" src="http://www.pmway.co.za/images/menulrdindex.png" width="111" style="float: left" usemap="#imgmap0" /><br />
	...
	<img class="img-fluid" alt="" height="1074" src="http://www.pmway.co.za/processesdash/imagesv6/ver66point4.png" width="842" usemap="#imgmap2" /> <br><br>

	<p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK
	version 6 guide.</p>
		<a href="http://www.pmway.co.za/v6/64.pdf#page=4" >
		<img class="img-fluid"

 alt="" height="1078" src="http://www.pmway.co.za/processesdash/imagesv6/64.png" width="635" /></a><br /><br /><p class="ctr">
 ...
 onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/64ittos.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
	<br>


		<img class="img-fluid" src="http://www.pmway.co.za/processesdash/images/mouseover.png" onclick="this.src='http://www.pmway.co.za/processesdash/imagesv6/64flow.png'" ondblclick="this.src='http://www.pmway.co.za/processesdash/images/mouseover.png'">
