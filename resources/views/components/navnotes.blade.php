{{-- BOOTSTRAP NAVIGATION COMPONENT - Notes Module --}}
            ...
            <div class="col">
                ...
                <div class="collapse navbar-collapse d-md-block" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('notes/categories') ? 'active' : '' }}" href="{{ route('notes.categories') }}">
                                <i class="bi bi-folder2 me-1"></i>Note Categories
                            </a>
                        </li>
                    </ul>
                </div>
