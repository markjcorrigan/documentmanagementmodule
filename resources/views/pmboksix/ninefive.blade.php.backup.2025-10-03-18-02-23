...
@section('content')
    <div class="container">
        ...
        <div align="center">
            ...
            <p class="ctr"><img class="img-fluid" alt="" height="1074" src="{{ asset('storage/images/ver69point5.png') }}" width="842" usemap="#imgmap2"></p>
            <br><br>
            <p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK version 6 guide.<br><a href="/pmboksixmanual/ninefive.pdf" ><img class="img-fluid" alt="" height="753" src="{{ asset('storage/images/95.png') }}" width="642"></a></p>
            <p class="ctr">ITTO's as an image from the PMBOK version 6 guide.<br>
                <img class="img-fluid" src="{{ asset('storage/images/mouseover.png') }}" onclick="this.src='{{ asset('storage/images/95ittos.png') }}'" ondblclick="this.src='{{ asset('storage/images/mouseover.png') }}'"><br><br>
                <img class="img-fluid" src="{{ asset('storage/images/mouseover.png') }}" onclick="this.src='{{ asset('storage/images/95flow.png') }}'" ondblclick="this.src='{{ asset('storage/images/mouseover.png') }}'"><br>
