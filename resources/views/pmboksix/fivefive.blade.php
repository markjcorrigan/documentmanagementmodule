...
@section('title', 'FiveFive')

@section('content')
    <div class="container">
        <h3>Validate Scope</h3>
        <h5>PG Monitoring and Controlling, KA Scope, #5.5</h5>
        <hr/>
        ...
        <div align="center">
            ...
            <map id="imgmap0" name="imgmap0">
                <area coords="39, 52, 71, 81" href="/pmboksix/sixsix" shape="rect" title="down">
                <area coords="0, 14, 36, 58" href="/pmboksix/fivefour" shape="rect" title="left">
                ...
                <area coords="76, 17, 109, 58" href="/pmboksix/fivesix" shape="rect" title="right">
            </map>
            <img class="img-fluid" alt="" height="82" src="/storage/images/menulrdindex.png" width="111" style="float: left" usemap="#imgmap0"/><br/>
            <p class="ctr"><img class="img-fluid" alt="" height="1074" src="/storage/images/ver65point5.png" width="842" usemap="#imgmap2"></p>
            <br><br>
            <p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK version 6 guide.<br><a href="/pmboksixmanual/fivefive.pdf" ><img class="img-fluid" alt="" height="697" src="/storage/images/55.png" width="622"></a></p>
            <p class="ctr">ITTO's as an image from the PMBOK version 6 guide.<br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/55ittos.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br><br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/55flow.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br>
