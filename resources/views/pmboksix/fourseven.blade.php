...
@section('title', 'FourSeven')

@section('content')
    <div class="container">
        <h3>Close Project or Phase</h3>
        <h5>PG Closing, KA Integration, #4.7</h5>
        <hr/>
        ...
        <div align="center">
            ...
            <map id="imgmap0" name="imgmap0">
                <area coords="39, 52, 71, 81" href="/pmboksix/fourseven" shape="rect" title="down">
                <area coords="0, 14, 36, 58" href="/pmboksix/fourfive" shape="rect" title="left">
                <area coords="38, 24, 72, 51" href="/pmboksix/close" shape="rect" title="up">
            ...
            <p class="ctr"><img class="img-fluid" alt="" height="1074" src="/storage/images/ver64point7.png" width="842" usemap="#imgmap2"></p>
            <br><br>
            <p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK version 6 guide.<br><a href="/pmboksixmanual/fourseven.pdf" ><img class="img-fluid" alt="" height="1036" src="/storage/images/47.png" width="709"></a></p>
            <p class="ctr">ITTO's as an image from the PMBOK version 6 guide.<br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/47ittos.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br><br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/47flow.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br>
