...
@section('title', 'FiveOne')

@section('content')
    <div class="container">
        <h3>Plan Scope Management</h3>
        <h5>PG Planning, KA Scope, #5.1</h5>
        <hr/>
        ...
        <div align="center">
            ...
            <map id="imgmap0" name="imgmap0">
                <area coords="39, 52, 71, 81" href="/pmboksix/fivetwo" shape="rect" title="down">
                <area coords="0, 14, 36, 58" href="/pmboksix/scope" shape="rect" title="left">
                <area coords="38, 24, 72, 51" href="/pmboksix/fourtwo" shape="rect" title="up">
                <area coords="35, 5, 75, 24" href="/pmway" shape="rect" title="index">
                <area coords="76, 17, 109, 58" href="/pmboksix/fivetwo" shape="rect" title="right">
            </map>
            <img class="img-fluid" alt="" height="82" src="/storage/images/menulrdindex.png" width="111" style="float: left" usemap="#imgmap0"/><br/>
            <p class="ctr"><img class="img-fluid" alt="" height="1074" src="/storage/images/ver65point1.png" width="842" usemap="#imgmap2"></p>
            <br><br>
            <p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK version 6 guide.<br><a href="/pmboksixmanual/fiveone.pdf" ><img class="img-fluid" alt="" height="431" src="/storage/images/51.png" width="648"></a></p>
            <p class="ctr">ITTO's as an image from the PMBOK version 6 guide.<br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/51ittos.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br><br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/51flow.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br>
