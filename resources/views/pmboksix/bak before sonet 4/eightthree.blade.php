...
@section('content')
    <div class="container">
        ...
        <div align="center">
            ...
            <p class="ctr"><img class="img-fluid" alt="" height="1074" src="{{ asset('storage/images/ver68point3.png') }}" width="842" usemap="#imgmap2"></p>
            <br><br>
            <p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK version 6 guide.<br><a href="/pmboksixmanual/eightthree.pdf" ><img class="img-fluid" alt="" height="816" src="{{ asset('storage/images/83.png') }}" width="626"></a></p>
            <p class="ctr">ITTO's as an image from the PMBOK version 6 guide.<br>
                <img class="img-fluid" src="{{ asset('storage/images/mouseover.png') }}" onclick="this.src='{{ asset('storage/images/83ittos.png') }}'" ondblclick="this.src='{{ asset('storage/images/mouseover.png') }}'"><br><br>
                <img class="img-fluid" src="{{ asset('storage/images/mouseover.png') }}" onclick="this.src='{{ asset('storage/images/83flow.png') }}'" ondblclick="this.src='{{ asset('storage/images/mouseover.png') }}'"><br>
