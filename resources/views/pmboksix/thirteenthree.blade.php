...
@section('title', 'ThirteenThree')

@section('content')
    <div class="container">
        <h3>Manage Stakeholder Engagement</h3>
        <h5>PG Executing, KA Stakeholder, #13.3</h5>
        <hr/>
        ...
        <div align="center">
            ...
            <map id="imgmap0" name="imgmap0">
                ...
                <area coords="0, 14, 36, 58" href="/pmboksix/thirteentwo" shape="rect" title="left">
                <area coords="38, 24, 72, 51" href="/pmboksix/twelvetwo" shape="rect" title="up">
            ...
            <p class="ctr"><img class="img-fluid" alt="" height="1074" src="/storage/images/ver613point3.png" width="842" usemap="#imgmap2"></p>
            <br><br>
            <p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK version 6 guide.<br><a href="/pmboksixmanual/thirteenthree.pdf" ><img class="img-fluid" alt="" height="739" src="/storage/images/133.png" width="640"></a></p>
            <p class="ctr">ITTO's as an image from the PMBOK version 6 guide.<br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/133ittos.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br><br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/133flow.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br>
