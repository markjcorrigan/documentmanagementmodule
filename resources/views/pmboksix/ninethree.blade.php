...
@section('title', 'NineThree')

@section('content')
    <div class="container">
        <h3>Acquire Resources</h3>
        <h5>PG Executing, KA Resource, #9.3</h5>
        <hr/>
        ...
        <div align="center">
            ...
            <map id="imgmap0" name="imgmap0">
                <area coords="39, 52, 71, 81" href="/pmboksix/ninefour" shape="rect" title="down">
                <area coords="0, 14, 36, 58" href="/pmboksix/ninetwo" shape="rect" title="left">
                <area coords="38, 24, 72, 51" href="/pmboksix/eighttwo" shape="rect" title="up">
                <area coords="35, 5, 75, 24" href="/pmway" shape="rect" title="index">
                <area coords="76, 17, 109, 58" href="/pmboksix/ninefour" shape="rect" title="right">
            </map>
            <img class="img-fluid" alt="" height="82" src="/storage/images/menulrdindex.png" width="111" style="float: left" usemap="#imgmap0"/><br/>
            <p class="ctr"><img class="img-fluid" alt="" height="1074" src="/storage/images/ver69point3.png" width="842" usemap="#imgmap2"></p>
            <br><br>
            <p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK version 6 guide.<br><a href="/pmboksixmanual/ninethree.pdf" ><img class="img-fluid" alt="" height="1054" src="/storage/images/93.png" width="626"></a></p>
            <p class="ctr">ITTO's as an image from the PMBOK version 6 guide.<br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/93ittos.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br><br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/93flow.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br>
