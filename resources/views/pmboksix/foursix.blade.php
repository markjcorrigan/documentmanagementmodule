...
@section('title', 'FourSix')

@section('content')
    <div class="container">
        <h3>Perform Integrated Change Control</h3>
        <h5>PG Monitoring and Controlling, KA Integration, #4.6</h5>
        <hr/>
        ...
        <div align="center">
            ...
            <map id="imgmap0" name="imgmap0">
                <area coords="39, 52, 71, 81" href="/pmboksix/fivesix" shape="rect" title="down">
                <area coords="0, 14, 36, 58" href="/pmboksix/fourfour" shape="rect" title="left">
                <area coords="38, 24, 72, 51" href="/pmboksix/fourfive" shape="rect" title="up">
            ...
            <p class="ctr"><img class="img-fluid" alt="" height="1074" src="/storage/images/ver64point6.png" width="842" usemap="#imgmap2"></p>
            <br><br>
            <p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK version 6 guide.<br><a href="/pmboksixmanual/foursix.pdf" ><img class="img-fluid" alt="" height="781" src="/storage/images/46.png" width="616"></a></p>
            <p class="ctr">ITTO's as an image from the PMBOK version 6 guide.<br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/46ittos.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br><br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/46flow.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br>
