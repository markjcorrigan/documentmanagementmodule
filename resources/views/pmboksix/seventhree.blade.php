...
@section('title', 'SevenThree')

@section('content')
    <div class="container">
        <h3>Determine Budget</h3>
        <h5>PG Planning, KA Cost, #7.3</h5>
        <hr/>
        ...
        <div align="center">
            ...
            <map id="imgmap0" name="imgmap0">
                <area coords="39, 52, 71, 81" href="/pmboksix/eightone" shape="rect" title="down">
                <area coords="0, 14, 36, 58" href="/pmboksix/cost" shape="rect" title="left">
                <area coords="38, 24, 72, 51" href="/pmboksix/seventwo" shape="rect" title="up">
            ...
            <p class="ctr"><img class="img-fluid" alt="" height="1074" src="/storage/images/ver67point3.png" width="842" usemap="#imgmap2"></p>
            <br><br>
            <p class="ctr">Inputs, Tools and Techniques, and Outputs (ITTO's) as a dashboard to the PMBOK version 6 guide.<br><a href="/pmboksixmanual/seventhree.pdf" ><img class="img-fluid" alt="" height="709" src="/storage/images/73.png" width="616"></a></p>
            <p class="ctr">ITTO's as an image from the PMBOK version 6 guide.<br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/73ittos.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br><br>
                <img class="img-fluid" src="/storage/images/mouseover.png" onclick="this.src='/storage/images/73flow.png'" ondblclick="this.src='/storage/images/mouseover.png'"><br>
