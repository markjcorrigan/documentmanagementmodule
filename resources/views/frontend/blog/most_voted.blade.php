...
<head>
    ...
    <meta name="description" content="Community's Favorite Blog Posts" />
    <script src="https://cdn.tailwindcss.com"></script>

    <!-- Site Title -->
    <title>Most Voted Posts - Blog</title>
...
<main class="site-content" id="content">
    ...
    <!-- MOST VOTED POSTS SECTION START -->
    <section class="full-width tj-post-details__area py-5">
                ...
                <div class="col-12 col-lg-10">
                    <div class="text-center">
                        ...
                        <h1 class="display-4 fw-bold mb-3">
                            ...
                            Community's Favorite Posts
                        </h1>
                        <p class="lead text-white">
                            Discover the most loved blog posts voted by our community members
                        </p>
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-12 col-lg-10 text-center">
                    <a href="{{ url('/blog') }}" class="btn btn-outline-primary btn-lg">
                        <i class="fa fa-arrow-left"></i> Back to All Blog Posts
                    </a>
                </div>
            </div>
